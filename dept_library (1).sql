...
(1, 'Introduction to the Theory of Computation', 'This book provides a comprehensive introduction to the theory of computation, including formal languages, automata, computability, and complexity theory.', 'Michael Sipser', 1, '2023-07-10 21:41:18'),
(2, 'Artificial Intelligence: A Modern Approach', 'This book offers a comprehensive and up-to-date introduction to the field of artificial intelligence, covering various AI techniques, including problem-solving, knowledge representation, machine learning, and natural language processing.', 'Stuart Russell, Peter Norvig', 2, '2023-07-10 21:41:18'),
...
(4, 'Design Patterns: Elements of Reusable Object-Oriented Software', 'This classic book presents the concept of design patterns in software development, offering reusable solutions to common design problems, and illustrating them using various programming languages.\r\n', 'Erich Gamma, Richard Helm, Ralph Johnson, John Vlissides', 5, '2023-07-10 21:41:18'),
(5, 'Computer Networks: A Systems Approach', 'This book provides a comprehensive introduction to computer networks, covering topics such as network protocols, architecture, network programming, and internet technologies.', 'Larry L. Peterson, Bruce S. Davie', 0, '2023-07-10 21:41:18'),
...
(8, 'Operating System Concepts', 'This book offers a thorough introduction to operating systems, covering topics such as process management, memory management, file systems, and I/O systems.', 'Abraham Silberschatz, Peter B. Galvin, Greg Gagne', 1, '2023-07-10 21:44:18'),
...
(12, 'The Algorithm Design Manual', 'This book offers a practical guide to algorithm design and analysis, providing a wide range of algorithms along with explanations, examples, and problem-solving techniques.', 'Steven S. Skiena', 0, '2023-07-10 21:40:18');
...
(21, 'ajayerumalla@gmail.com', 'ajayerumalla@gmail.com', '1', '2023-07-13 18:28:09'),
(22, 'rgukt_b1820811', '2081@gmail', '1', '2023-07-13 19:18:34');
...
ALTER TABLE `students`
  ADD PRIMARY KEY (`sid`,`username`) USING BTREE;
